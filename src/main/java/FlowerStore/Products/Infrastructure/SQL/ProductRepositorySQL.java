...
public class ProductRepositorySQL implements ProductsRepository {
    ...
    public List<Product> getAllProducts() {
        ...
        try (PreparedStatement statement = mySQLConnection.getSqlDatabase().prepareStatement(query);
    ...
    public void addPrimaryStock() {
        ...
        try (PreparedStatement productStatement = mySQLConnection.getSqlDatabase().prepareStatement(insertProductQuery, Statement.RETURN_GENERATED_KEYS)) {
