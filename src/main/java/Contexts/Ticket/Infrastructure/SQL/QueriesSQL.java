...
public class QueriesSQL {
    ...
    public static final String SQL_SELECT_TICKET = "SELECT t.idticket, t.date, p.idproduct, p.name, p.quantity, p.price, p.type, " +
    ...
    public static final String SQL_SELECT_LAST_TICKET = "SELECT t.idticket, t.date, p.idproduct, p.name, p.quantity, p.price, p.type, " +
            "COALESCE(f.color, tr.height, d.material) AS attribute, pt.amount " +
            "FROM ticket t " +
            "INNER JOIN product_ticket pt ON t.idticket = pt.ticket_idticket " +
            "INNER JOIN product p ON pt.product_idproduct = p.idproduct " +
    ...
    public static final String SQL_SELECT_PRODUCT_TICKET = "SELECT t.date, pt.idproduct_ticket, pt.amount, p.idproduct, p.name, p.quantity, p.price, p.type, pt.ticket_idticket, " +
